...
`EXTERNAL_STATICLIBS`, `<lib>_PATH`, `<lib>_DIR`, `SUBDIRS`, `CHECKDIRS`,
`RESOURCES`, `BUILD_VARIANT`, standard compiler and linker variables, and their
target-specific forms. Preserve this small
